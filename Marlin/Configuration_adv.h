...
//#define HOMING_BACKOFF_MM { X_MIN_POS, Y_MIN_POS, 0 }  // (mm) Move away from the endstops after homing
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { HOMING_FEEDRATE_XY, HOMING_FEEDRATE_XY, HOMING_FEEDRATE_Z, 120 } // Feedrates for manual moves along X, Y, Z, E from panel
 ...
 */
   ...
   */
  //#define STATUS_COMBINE_HEATERS      // Use combined heater images instead of separate ones // makes bed temp disapear
...
#define CUSTOM_USER_MENUS
  ...
  #define USER_DESC_7 "Lin Adv K0.2"
  #define USER_GCODE_7 "M900 K0.2\nM500"

  #define USER_DESC_8 "Lin Adv K0.3"
  #define USER_GCODE_8 "M900 K0.3\nM500"

  #define USER_DESC_9 "Lin Adv K0.4"
  #define USER_GCODE_9 "M900 K0.4\nM500"

  #define USER_DESC_10 "Lin Adv K0.5"
  #define USER_GCODE_10 "M900 K0.5\nM500"

  #define USER_DESC_11 "Lin Adv K0.6"
  #define USER_GCODE_11 "M900 K0.6\nM500"
